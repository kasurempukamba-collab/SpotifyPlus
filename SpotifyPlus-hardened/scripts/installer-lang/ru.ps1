[PSCustomObject]@{
    Welcome         = "
╔══════════════════════════════════════╗
║ Добро пожаловать в SpotifyPlus для Windows ║
╚══════════════════════════════════════╝"
    ...
    NewV2           = "Ваша версия Spotify ({0}) не тестировалась. Стабильная версия для SpotifyPlus — {1}"
    ...
    Spicetify       = "Обнаружен Spicetify, он должен быть установлен после SpotifyPlus, открыть рекомендуемые действия в FAQ ? [Y/N]"
    ...
    NoRestore       = "SpotifyPlus уже был установлен, но файл для восстановления xpui.bak не найден. `nУдалите клиент Spotify и снова запустите Install.bat"
