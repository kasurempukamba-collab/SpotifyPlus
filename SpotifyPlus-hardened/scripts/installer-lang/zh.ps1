...
╚════════════════════════════════╝"
    ...
    Spicetify       = "检测到 Spicetify，它必须在安装 SpotifyPlus 后进行安装。是否启用 FAQ 中的建议操作？ [Y/N]"
    NoRestore       = "SpotifyPlus 已经安装，但是找不到文件 xpui.bak . `n请重新安装 Spotify 客户端后再次运行 install.bat"
