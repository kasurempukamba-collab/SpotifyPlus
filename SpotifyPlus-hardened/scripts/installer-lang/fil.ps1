[PSCustomObject]@{
    ...
    Welcome         = "
╔═══════════════════════════════════════════════╗
║ Maligayang pagdating sa SpotifyPlus para sa Windows ║
╚═══════════════════════════════════════════════╝"
    ...
    Spicetify       = "Nakadetect ang Spicetify, ito ay dapat na mai-install pagkatapos ng SpotifyPlus, buksan ang rekomendadong mga hakbang sa FAQ? [Y/N]"
    NoRestore       = "Nakainstall na ang SpotifyPlus, hindi nakita ang xpui.bak. `nMangyaring mag-uninstall ng Spotify client at patakbuhin muli ang Install.bat"
