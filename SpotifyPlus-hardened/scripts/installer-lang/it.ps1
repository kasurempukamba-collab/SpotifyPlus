[PSCustomObject]@{
    ...
    Welcome         = "
╔═══════════════════════════════╗
║ Benvenuti a SpotifyPlus per Windows ║
╚═══════════════════════════════╝"
    ...
    NewV2           = "La tua versione {0} di Spotify non è stata testata. La versione stabile per SpotifyPlus è {1}"
    ...
    Spicetify       = "Spicetify rilevato, deve essere installato dopo SpotifyPlus, aprire le azioni consigliate nelle FAQ ? [Y/N]"
    NoRestore       = "SpotifyPlus è già stato installato, xpui.bak non trovato. `nPer favore, disinstalla Spotify e riapri il file Install.bat"
