[PSCustomObject]@{
    ...
    Welcome         = "
╔═════════════════════════════════════════════╗
║ Le damos la bienvenida a SpotifyPlus para Windows ║
╚═════════════════════════════════════════════╝"
    ...
    Spicetify       = "Spicetify detectado, debe ser instalado después de SpotifyPlus, abrir acciones recomendadas en las preguntas frecuentes? [Y/N]"
    NoRestore       = "SpotifyPlus ya ha sido instalado, xpui.bak no se encuentra. `nDesinstale el cliente de Spotify y ejecute Install.bat de nuevo"
