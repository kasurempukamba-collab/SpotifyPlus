[PSCustomObject]@{
    ...
    Welcome         = "
╔════════════════════════════╗
║ Witamy w SpotifyPlus dla Windows ║
╚════════════════════════════╝"
    ...
    Spicetify       = "Wykryto Spicetify. Należy zainstalować je po SpotifyPlus. Czy otworzyć zalecane działania w FAQ? [Y/N]"
    NoRestore       = "SpotifyPlus został już pobrany, lecz xpui.bak nie został znaleziony. `nProszę odinstalować klienta Spotify i uruchomić Install.bat ponownie"
