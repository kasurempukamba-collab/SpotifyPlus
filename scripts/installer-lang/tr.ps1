[PSCustomObject]@{
    ...
    Welcome         = "
╔══════════════════════════════════╗
║ Windows için SpotifyPlus'e Hoşgeldiniz ║
╚══════════════════════════════════╝"
    ...
    NoRestore       = "SpotifyPlus zaten kurulmuş, xpui.bak dosyası bulunamadı. `nLütfen Spotify istemcisini kaldırın ve Install.bat dosyasını tekrar çalıştırın"
