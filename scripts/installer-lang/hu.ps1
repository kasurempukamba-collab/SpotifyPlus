[PSCustomObject]@{
    ...
    Welcome         = "
╔════════════════════════════════════════════╗
║ Üdvözöllek a SpotifyPlus Windowsos telepítőjében ║
╚════════════════════════════════════════════╝"
    ...
    NoRestore       = "A SpotifyPlus már telepítve van, az xpui.bak nem található. `nTávolítsa el a Spotify klienst, és futtassa újra az Install.bat fájlt."
