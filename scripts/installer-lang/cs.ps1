[PSCustomObject]@{
    ...
    Welcome         = "
╔═════════════════════════════╗
║ Vítejte v SpotifyPlus pro Windows ║
╚═════════════════════════════╝"
    ...
    Spicetify       = "Spicetify nalezeno, musí být nainstalováno po SpotifyPlus, otevřít doporučené akce ve FAQ? [Y/N]"
    NoRestore       = "SpotifyPlus byl již nainstalován, xpui.bak se nenašlo. `nProsím odinstalujte klienta Spotify a spusťte Install.bat znovu"
