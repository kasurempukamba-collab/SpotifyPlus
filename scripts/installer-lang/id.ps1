[PSCustomObject]@{
    ...
    Welcome         = "
╔═══════════════════════════════════════╗
║ Selamat datang di SpotifyPlus untuk Windows ║
╚═══════════════════════════════════════╝"
    ...
    Spicetify       = "Spicetify terdeteksi, harus diinstal setelah SpotifyPlus, buka tindakan yang direkomendasikan di FAQ? [Y/N]"
    NoRestore       = "SpotifyPlus sudah diinstal, xpui.bak tidak ditemukan. `nSilakan uninstall aplikasi Spotify dan jalankan Install.bat lagi"
