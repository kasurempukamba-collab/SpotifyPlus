[PSCustomObject]@{
    ...
    Welcome         = "
╔═══════════════════════════════╗
║ Tervetuloa SpotifyPlus:n Windowsiin ║
╚═══════════════════════════════╝"
    ...
    NoRestore       = "SpotifyPlus on jo asennettu, xpui.bak tiedostoa ei löynyt. `nAsenna spotify uudelleen ja suorita Install.bat tiedosto uudelleen"
