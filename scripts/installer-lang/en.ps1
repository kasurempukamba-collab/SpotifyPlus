...
╚══════════════════════════════╝"
    ...
    NewV2           = "Your Spotify version ({0}) has not been tested. The stable version for SpotifyPlus is {1}"
    ...
    NoRestore       = "SpotifyPlus has already been installed, xpui.bak not found. `nPlease uninstall Spotify client and run Install.bat again"
