...
╚══════════════════════════════╝"
    ...
    Spicetify       = "Detektovan je Spicetify koji mora biti instaliran nakon SpotifyPlus-a, otvori preporučene akcije u FAQ-u? [Y/N]"
    NoRestore       = "SpotifyPlus je već bio instaliran, xpui.bak nije pronađen. `nMolimo deinstalirajte Spotify klijent i pokrenite Install.bat ponovo"
